	...
	render() {
		return (
			<div className="formLine">
				...
				<Input val={this.props.val.number} change={this.props.change} name="number" for="Phone Number" input="num"></Input>
				<Input val={this.props.val.email} change={this.props.change} name="email" for="Email" input="email"></Input>
				<Input val={this.props.val.about} change={this.props.change} name="about" for="About You" input="textarea"></Input>
			</div>
		);
	}
}
